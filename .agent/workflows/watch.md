...
1. Zavolej tool `agentation_watch_annotations` s parametrem `timeoutSeconds: 300` a `batchWindowSeconds: 1`.
2. Pokud se vrátí anotace:
   ...
   - Po opravě zavolej `agentation_resolve` s ID anotace a krátkým shrnutím.
